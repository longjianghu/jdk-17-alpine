...
- `17-alpine-zh`: 17 版本基础上增加中文字体支持
- `21`: 基于 amazoncorretto:21-alpine3.22-jdk
- `21-alpine-zh`: 21 版本基础上增加中文字体支持
...
- `longjianghu/jdk:17-alpine-zh`: 17 版本基础上安装中文字体（文泉驿正黑），适用于需要生成中文验证码的场景
- `longjianghu/jdk:21`: JDK 21 基础镜像，指定时区为上海
- `longjianghu/jdk:21-alpine-zh`: 21 版本基础上安装中文字体（文泉驿正黑），适用于需要生成中文验证码的场景